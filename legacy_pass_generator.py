"""Temporary Tkinter rollback entry point for GET-Passes 2.0 acceptance.

This file preserves the pre-Phase-5 production launcher so a workstation can
fall back to the proven Tkinter UI during physical printer acceptance.
"""
